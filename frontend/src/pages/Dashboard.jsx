...
export default function Dashboard() {
  const [filters, setFilters] = useState({ states: [], cities: [], categories: [] });
  const [selectedFilters, setSelectedFilters] = useState({ state: '', city: '', category: '' });
  ...
  const clearFilters = () => {
    setSelectedFilters({ state: '', city: '', category: '' });
    setSearchQuery('');
  };
      ...
      <div className="bg-gradient-to-br from-[#0066CC] to-[#0052A3] text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-lg text-blue-100 font-body max-w-2xl">
            Explore top-rated colleges across India. Filter by state, city, and category to find the perfect institution.
          </p>
        </div>
      </div>
        ...
        <Card className="shadow-lg border-0">
          <CardContent className="p-6">
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              >
                <SelectTrigger 
                  className="w-full lg:w-48 h-12 font-body border-slate-300"
            ...
            {colleges.map((college, index) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center gap-2 text-[#475569] font-body text-sm mb-3">
